...
public class GitHubLoginTest extends TestBase
{
     ...
     * and verify the Test Coverage Data image is visible in the README.
     */
    @Test(description="verify Test Coverage Data image is visible in the QA-Dashboard repository README", dataProvider = "getConfig", groups = {GROUP_REGRESSION, GROUP_WEB})
    ...
    public void navigateToRepoAndValidateCoverageImage(Config config)
    {
        ...
        config.logStep("Verify Test Coverage Data image is visible in the repository README");
