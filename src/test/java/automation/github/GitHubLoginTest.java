...
public class GitHubLoginTest extends TestBase
{
     ...
     */
    @Test(description="navigate to GitHub repo and validate test coverage image is visible in README", dataProvider = "getConfig", groups = {GROUP_REGRESSION, GROUP_WEB})
    ...
    public void navigateToRepoAndValidateCoverageImage(Config config)
    {
        ...
        AssertHelper.assertTrue(config, repoPage.isTestCoverageImageVisible(),
            "Test Coverage Data image should be visible in the README section");
    }
}
