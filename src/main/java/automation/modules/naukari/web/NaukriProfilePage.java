...
/**
 * Naukri profile page — exposes read and edit operations for the Profile
 * Summary section.
 */
public class NaukriProfilePage extends BasePage {
    ...
    /**
     * Replaces the entire content of the Profile Summary editor with the given
     * text.
     *
    ...
    /**
     * Returns true if a success confirmation toast appears within 5 seconds of
     * saving.
     * The optional wait ensures the test is not blocked if the toast is dismissed
     * quickly.
     */
