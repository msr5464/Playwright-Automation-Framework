...
public class GitHubLoginTest extends TestBase
{
     ...
     */
    @Test(description="verify FCT Coverage screenshot is visible in README of QA-Dashboard repo", dataProvider = "getConfig", groups = {GROUP_REGRESSION, GROUP_WEB})
    ...
    public void validateFctCoverageScreenshotInReadme(Config config)
    {
        ...
        config.logStep("Login to GitHub");
        github.doLogin(username, password);

        config.logStep("Navigate to automationdemo/QA-Dashboard repository");
        RepoPage repoPage = github.navigateToRepo("https://github.com/automationdemo/QA-Dashboard");
