...
public class GitHubLoginTest extends TestBase
{
    ...
    /**
     * Login to GitHub, navigate to automationdemo/QA-Dashboard repository via direct URL,
     * and verify the FCT Test Coverage Data screenshot is visible in the README.
     */
    @Test(description="Login to GitHub, navigate to automationdemo/QA-Dashboard repo, and verify FCT Coverage screenshot is visible in README", dataProvider = "getConfig", groups = {GROUP_REGRESSION, GROUP_WEB})
    ...
    public void verifyFctCoverageScreenshotInReadme(Config config)
    {
        ...
        AssertHelper.assertTrue(config, repoPage.isFctCoverageScreenshotVisible(),
            "FCT Coverage screenshot should be visible in README");
    }
}
