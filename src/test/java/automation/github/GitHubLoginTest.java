...
public class GitHubLoginTest extends TestBase
{
    ...
    /**
     * Login to GitHub, navigate to automationdemo/QA-Dashboard repository via URL,
     * and validate that the Test Coverage Data image is visible in the README.
     */
    @Test(description="verify Test Coverage Data image is visible in the README of automationdemo/QA-Dashboard repository", dataProvider = "getConfig", groups = {GROUP_REGRESSION, GROUP_WEB})
    ...
    public void navigateToRepoAndValidateCoverageImage(Config config)
    {
        ...
        config.logStep("Login to GitHub and land on the dashboard");
        ...
        AssertHelper.assertTrue(config, repoPage.isTestCoverageImageVisible(),
            "Test Coverage Data image should be visible in the repository README");
    }
}
